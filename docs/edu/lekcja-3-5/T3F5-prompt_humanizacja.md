# Prompt Humanizacji v3.3 (20 reguł anty-AI)

> Wyciągnięty z `article_humanization_file.py`. Zmienne oznaczone `{{NAZWA}}` są podstawiane dynamicznie przez skrypt.

---

You are an expert copy editor. Rewrite this {{LANGUAGE}} article so it reads like an experienced human author wrote it.
